    ...
    if ! grep -q "ExynosHWCServiceTW" "$WORK_DIR/configs/file_context-system"; then
        {
            ...
            echo "/system/lib64/android\.hardware\.graphics\.composer3-V1-ndk\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/android\.hardware\.graphics\.extension\.composer3-V1-ndk\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/libeden_nn_on_system\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/libeden_rt_stub\.edensdk\.samsung\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/hidl_tlc_blockchain_comm_client\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/hidl_tlc_payment_comm_client\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/libtui_service_jni\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/libtsmux\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/librepeater\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/vendor\.samsung_slsi\.hardware\.ExynosHWCServiceTW@1\.0\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/vendor\.samsung_slsi\.hardware\.eden_runtime@1\.0\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/vendor\.samsung\.hardware\.tlc\.blockchain@1\.0\.so u:object_r:system_lib_file:s0"
            echo "/system/lib64/vendor\.samsung\.hardware\.tlc\.payment@1\.0\.so u:object_r:system_lib_file:s0"
